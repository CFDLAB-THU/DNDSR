...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{perfVES_nolim.png}  %需调整
    \caption{无限制器性能对比}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{perfVES_fulllim.png}  %需调整
    \caption{限制器全开性能对比}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{scaleEff.png}  %需调整
...
\begin{figure}[htbp]
    \centering
    \subfloat[$t=4.6$]{
        \includegraphics[width=7cm]{BallMesh_Ball4.png}
    }
    \subfloat[$t=7.2$]{
        \includegraphics[width=7cm]{BallRe1000_A.png}
    }\\
    \subfloat[$t=8.0$]{
        \includegraphics[width=7cm]{BallRe1000_B.png}
    }
    \subfloat[$t=10$]{
        \includegraphics[width=7cm]{BallRe1000_C.png}
    }
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{Uniform256_3D_Periodic_TGV_5000.png}  
    \caption{泰勒格林涡$256^3$，
    曲面为$Q=0$等值面速度大小染色}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=12cm]{EkSpec128.png} 
    \caption{泰勒格林涡能谱}
    \label{fig:EkSpec128}
\end{figure}
